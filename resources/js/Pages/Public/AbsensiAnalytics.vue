...
<template>
    ...
    <MenuLayout>
        <div class="min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
            ...
            <nav
                ...
                <div class="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
                    <div class="flex items-center gap-2.5">
                        ...
                        <span class="text-sm font-bold text-slate-800 dark:text-white">Data Statistik Kehadiran
                            Kelas</span>
                    </div>
                ...
                <!-- ══ BANNER INFO PUBLIK ═════════════════════════════════════════ -->
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-b-xl border-b border-blue-100 dark:border-blue-800">
            ...
            <main class="mx-auto sm:py-6 space-y-5 pb-16">

                <!-- ══ STEP 1: PILIH KELAS ════════════════════════════════════ -->
                <template v-if="!kelas">
                    <div class="text-center py-6">
                        <h1 class="text-2xl font-extrabold text-slate-800 dark:text-white">Pilih kelas terlebih dahulu
                        </h1>
                        <p class="mt-1.5 text-sm text-slate-500 dark:text-slate-400">
                            Semua guru dan siswa dapat melihat statistik kehadiran kelas secara transparan dan terbuka.
                        </p>
                    </div>
                ...
                <template v-else>
                        ...
                        <div class="flex flex-wrap items-end gap-3">
                            <template v-if="filterMode === 'bulan'">
                                <div class="flex flex-col gap-1 sm:w-auto w-full">
                                    <label
                                        class="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Periode
                                        Bulan</label>
                            ...
                            <div class="flex sm:w-auto w-full justify-center items-center">
                    ...
                    <template v-if="hasData">
                        ...
                        <div class="flex items-center flex-wrap gap-3">
                            <div class="flex w-full gap-4 sm:w-auto sm:justify-start justify-between">
                                <span
                                    class="inline-flex items-center gap-2 bg-slate-900 dark:bg-slate-950 text-sky-300 rounded-full text-xs font-bold">
                                    📅 Periode {{ label }}
                                </span>
                        ...
                        <div v-if="bottomSiswa.length"
                            ...
                            <p class="text-sm text-rose-700 dark:text-rose-300">
                                <strong>{{ bottomSiswa.length }} siswa</strong> memiliki tingkat persentase kehadiran di
                                bawah {{
                                    threshold
                                }}%.
                            </p>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                            <div
                                ...
                                <div
                                    :class="['text-2xl font-extrabold leading-none font-mono', avgClass(avgKehadiran)]">
                            ...
                            <div
                                ...
                                <div class="text-lg mb-1.5">📅</div>
                                <div
                                    class="text-2xl font-extrabold leading-none font-mono text-slate-800 dark:text-white">
                            ...
                            <div
                                ...
                                <div class="text-lg mb-1.5">📋</div>
                                <div
                                    class="text-2xl font-extrabold leading-none font-mono text-sky-700 dark:text-sky-300">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-5 gap-4">
                            ...
                            <div
                                ...
                                <div style="position:relative;height:200px;">
                                    <canvas id="pubDonut" role="img"
                                        aria-label="Distribusi status kehadiran kelas.">Distribusi kehadiran
                                        kelas.</canvas>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div style="position:relative;height:220px;">
                                    <canvas id="pubBarDaily" role="img"
                                        aria-label="Bar chart kehadiran per hari.">Kehadiran
                                        harian kelas.</canvas>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                                ...
                                Informasi sensitif seperti NIS, nomor telepon, dan catatan absensi pribadi tidak
                                ditampilkan
